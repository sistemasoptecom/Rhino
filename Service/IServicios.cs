...
namespace Rhino.Service
{
    ...
    public interface IServicios
    {
       ...
       BodyStyle = WebMessageBodyStyle.WrappedRequest
        ...
        [WebInvoke(
           Method = "POST",
           UriTemplate = "/PreloadProveedores",
           ResponseFormat = WebMessageFormat.Json,
           RequestFormat = WebMessageFormat.Json,
           BodyStyle = WebMessageBodyStyle.WrappedRequest
           )]
        string PreloadProveedores();
        ...
        [WebInvoke(
                Method = "POST",
                UriTemplate = "/CreateProveedores",
                ResponseFormat = WebMessageFormat.Json,
                RequestFormat = WebMessageFormat.Json,
                BodyStyle = WebMessageBodyStyle.WrappedRequest
                )]
        string CreateProveedores(string json);

        [OperationContract]
        [WebInvoke(
        Method = "POST",
        UriTemplate = "/UpdateProveedores",
        ResponseFormat = WebMessageFormat.Json,
        RequestFormat = WebMessageFormat.Json,
        BodyStyle = WebMessageBodyStyle.WrappedRequest
        )]
        string UpdateProveedores(string json);

        [OperationContract]
        [WebInvoke(
        Method = "POST",
        UriTemplate = "/ReadProveedores",
        ResponseFormat = WebMessageFormat.Json,
        RequestFormat = WebMessageFormat.Json,
        BodyStyle = WebMessageBodyStyle.WrappedRequest
        )]
        string ReadProveedores(string json);

                [OperationContract]
        [WebInvoke(
        Method = "POST",
        UriTemplate = "/DeleteProveedores",
        ResponseFormat = WebMessageFormat.Json,
        RequestFormat = WebMessageFormat.Json,
        BodyStyle = WebMessageBodyStyle.WrappedRequest
        )]
        string DeleteProveedores(string json);


        [OperationContract]
        [WebInvoke(
     Method = "POST",
     UriTemplate = "/ValidateProveedores",
     ResponseFormat = WebMessageFormat.Json,
     RequestFormat = WebMessageFormat.Json,
     BodyStyle = WebMessageBodyStyle.WrappedRequest
     )]
        string ValidateProveedores(string json);
